...
const dialogues = {
	...
	"test_godot" : [{"id":"0","type":"message","content":"Hello"},{"id":"1","type":"message","content":"This is a test"},{"id":"2","type":"choice","content":[{"id":4,"type":"choiceOption","content":[{"id":5,"type":"message","content":"Look's like it worked :)"},{"id":"6","type":"end","content":""},{"id":11,"type":"placeholder"}],"display":"ok"},{"id":7,"type":"choiceOption","content":[{"id":8,"type":"message","content":"i think it's working but i will bring you back to test the move to :3"},{"id":"9","type":"moveTo","content":"0"},{"id":10,"type":"placeholder"}],"display":"okay"}],"display":"I hope it will work"},{"id":3,"type":"placeholder"}],
	"test_godot2" : [{"id":"0","type":"message","content":"Hello"},{"id":"1","type":"message","content":"This is a test"},{"id":"2","type":"choice","content":[{"id":4,"type":"choiceOption","content":[{"id":5,"type":"message","content":"Look's like it worked :)"},{"id":"6","type":"end","content":""},{"id":11,"type":"placeholder"}],"display":"ok"},{"id":7,"type":"choiceOption","content":[{"id":8,"type":"message","content":"i think it's working but i will bring you back to test the move to :3"},{"id":"9","type":"moveTo","content":"5"},{"id":10,"type":"placeholder"}],"display":"okay"}],"display":"I hope it will work"},{"id":3,"type":"placeholder"}],
	"test3" : [{"id":"0","type":"message","content":"tgdf"},{"id":"1","type":"choice","content":[{"id":3,"type":"choiceOption","content":[{"id":4,"type":"message","content":"wq"},{"id":"5","type":"end","content":""},{"id":14,"type":"placeholder"}],"display":"qew"},{"id":6,"type":"choiceOption","content":[{"id":7,"type":"message","content":"qew"},{"id":"8","type":"end","content":""},{"id":13,"type":"placeholder"}],"display":"qeww"},{"id":9,"type":"choiceOption","content":[{"id":10,"type":"message","content":"wqe"},{"id":"11","type":"end","content":""},{"id":12,"type":"placeholder"}],"display":"wqeq"},{"id":15,"type":"choiceOption","content":[{"id":16,"type":"message","content":"qewqw"},{"id":"17","type":"end","content":""},{"id":18,"type":"placeholder"}],"display":"wqdeqwd"}],"display":"re"},{"id":2,"type":"placeholder"}],
